...
const gigData = {
  ...
  images: [
    ...
    "https://placehold.co/500x500", // Add more image placeholders
    "https://placehold.co/500x500",
  ],
  descriptionTemplate: {
    others: {
  ...
  reviews: [
    {
      reviewer: {
        ...
        country: "USA",
        sub: "user_id_123",
        profilePicture: "https://avatar.iran.liara.run/public/35",
      },
      gig: {
        sub: "6679b0b9b853321d1739d18d",
        title: "Amazing Gig Title!",
        slug: "amazing-gig-title",
      },
      seller: {
        username: "jane.smith",
        country: "Canada",
      ...
      rating: 4,
      comment: "This is a great gig! I highly recommend it.",
      isPinned: false,
      _id: "66901a0d75c30e3512cc4d68",
      createdAt: new Date(), // Manually set created date (July 20, 2023)
      updatedAt: new Date(), // Manually set updated date (July 24, 2024)
    },
    {
      reviewer: {
        username: "john.doe",
      ...
      isPinned: false,
      _id: "66901a0d75c30e3512cc4d68",
      createdAt: new Date(), // Manually set created date (December 15, 2022)
      updatedAt: new Date(), // Manually set updated date (June 2, 2023)
    },
    {
      reviewer: {
        username: "john.doe",
      ...
      comment: "This is a great gig! I highly recommend it.",
      isPinned: false,
      _id: "66901be188b173876d3f382d",
      createdAt: new Date(), // Manually set created date (February 10, 2024)
      updatedAt: new Date(), // Manually set updated date (July 18, 2024)
    },
  ],
};
