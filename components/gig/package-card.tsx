...
function PackageCard({ packages, username, expressPackage }: Prop) {
  const [selectedPackage, setSelectedSize] = useState();

  return (
    <Card radius="sm">
      <CardHeader className="flex z-0 flex-col items-start px-6 pb-0 pt-5">
        ...
        {expressPackage && (
          <>
            ...
            <p className="pl-3 mb-2 text-tiny text-default-600 dark:text-default-400">
              Make <span className="text-pretty font-bold">{username}</span>{" "}
              work faster
            </p>
