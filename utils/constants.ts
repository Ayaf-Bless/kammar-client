export const BACK_END_BASE_URL = process.env.API_BASE_URL;
...
export const countries = countriesInfo
  .sort((a, b) => a.name.localeCompare(b.name))
  .map((country) => {
    return {
      ...country,
      flag: `http://flags.fmcdn.net/data/flags/mini/${country.code.toLowerCase()}.png`,
    };
  });
...
//   flag: countriesInfo.map((country) => {
//     return `http://flags.fmcdn.net/data/flags/mini/${country.code.toLowerCase()}.png`;
//   }),
// };
